...
// 1. 객체리터럴 방식으로 dreamCar 객체를 생성해주세요
const dreamCar = {
    brand: '페라리',
    model: '488 GTB',
    year: 2021,
...
console.log(dreamCar.model); // 출력: '488 GTB'

// 3. 대괄호 연산자(bracket notation)를 사용하여 dreamCar의 brand 값을 출력하세요.
console.log(dreamCar['brand']); // 출력: '페라리'
...
// 6. 생성자 함수로 객체 생성
const dreamCar1 = new Car('페라리', '488 GTB', 2021);

// 마침표 연산자로 메소드 호출하기
dreamCar1.myDreamCar(); // 출력: '제 드림카는 2021년식 페라리 회사의 488 GTB입니다.'
